    ...
    Markdown.Converter = function () {
        ...
        function _DoImages(text) {
            ...
            */
            ...
            // Class support
            text = text.replace(/(<img.*)\/>\{([A-Za-z0-9-_\s]*)\}/g, writeImageTagClasses);
        ...
        function writeImageTagClasses(wholeMatch, m1, m2, m3, m4, m5, m6, m7) {
            var result = wholeMatch.replace('/>{'+m2+'}', 'class="'+m2+'" />');
            return result;
        }
