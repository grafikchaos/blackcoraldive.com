...
?>
  ...
  <div id="page" class="<?php print $classes; ?> clearfix">

    <?php print render($page['header']); ?>

    <?php $content_region = $tabs || $title || $page['content'] || $messages || $page['help']; ?>
    <?php if ($content_region || $page['sidebar_second']): ?>
      <div id="main-wrapper" class="row-fluid">
        ...
        <?php if ($page['sidebar_second']): ?>
          <div id="sidebar-second" class="sidebar span">
