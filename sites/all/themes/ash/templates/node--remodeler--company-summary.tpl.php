<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <h5><?php print $node->member_company_license_number; ?></h5>
  ...
  <hr />
  <?php 
    $showcases = variable_get('showcase_remodeler_active', array());
    $showcases += variable_get('showcase_remodeler_archive', array());
    $showcases = implode('+', $showcases);
  ?>  
  <a href="<?php print url('homes/remodeled'); ?>?company_name=<?php print urlencode($node->title); ?>&showcase=<?php print $showcases; ?>" class="test">View more homes by <?php print $node->member_company_title; ?></a>
  <hr />
