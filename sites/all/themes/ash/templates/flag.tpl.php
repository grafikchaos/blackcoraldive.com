...
//   case 'favorite':
//     if($action == 'flag'){
//       $icon = '<i class="icon-heart" style="color:#B94A48;"></i> ';
//     }else{
//       $icon = '<i class="icon-heart-empty" style="color:#B94A48;"></i> ';
//     }
//     break;
// }
?>
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?> btn btn-mini" rel="nofollow"><?php print $icon.$link_text; ?></a><span class="flag-throbber">&nbsp;</span>
  <?php else: ?>
