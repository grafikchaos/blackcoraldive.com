<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> <?php if(!empty($content['field_splash_image']['#items'])): ?>splash-image<?php endif; ?> node-profile clearfix"<?php print $attributes; ?>>
  ...
  <?php
    ...
    hide($content['field_specialties']);
	  ...
	  <div class="span12">
	  	<div class="member-top-social">
				<ul>
					...
					<li class="member-top-social-like"><div class="info">Like this vender</div> <?php print render($content['fb_social_node_builder_remodeler_associate']); ?></li>
				</ul>
			</div>
  ...
  <div class="member-gallery row-fluid">
    <div class="span12">
      <h3 class="title gallery-title"><i class="icon-camera"></i> Vendor Gallery</h3>
  ...
  <div class="member-details row-fluid">
    <div class="span12">
      <h3 class="title list-title"><i class="icon-bookmark-empty"></i> Vendor Details</h3>
      <?php print render($content['field_description']); ?>
      <div class="list">
        <?php
          print render($content['field_address']);
        	print render($content['field_specialties']);
  ...
  <div id="contact-form" class="member-email row-fluid">
    <div class="span12">
    	 <h3 class="title email-title"><i class="icon-envelope"></i> Email this Vendor</h3>
